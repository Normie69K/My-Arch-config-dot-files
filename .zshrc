...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting zsh-completions autoenv)
...
# Set the default editor for your terminal
# export EDITOR="vim"

# You can use autoenv if you want to load environment variables automatically when entering a directory that has a .env file.
# eval "$(autoenv init -)"
...
# Enable auto-correction feature from Oh My Zsh
ENABLE_CORRECTION="true"

# Optional: Enable auto-update and set frequency (in days)
